    ...
    for session in sessions:
        ...
        for condition in conditions:
            ...
            try:
                ...
                out_file.to_csv(f'{deriv_dir}/idconn-v0.1-presub+90.g6973d15/fci_van-def_network-connectivity.tsv', sep='\t')
                ...
                van_def_node_conn.to_csv(f'{deriv_dir}/idconn-v0.1-presub+90.g6973d15/fci_van-def_node-connectivity.tsv', sep='\t')
